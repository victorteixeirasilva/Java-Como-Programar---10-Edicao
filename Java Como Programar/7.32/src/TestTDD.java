...
public class TestTDD {
    ...
    //A) um par
    public static boolean umPar(ArrayList<Card> hand){
        return DeckOfCards.temUmPar(hand);
    }
    ...
    //B) dois pares
    public static boolean doisPares(ArrayList<Card> hand){
        return DeckOfCards.temDoisPares(hand);
    }
    ...
    //C) trica (por exemplo, três valetes)
    public static boolean trinca(ArrayList<Card> hand){
        return DeckOfCards.temTrinca(hand);
    }
    ...
    //D) quadra (por exemplo, quatro ases)
    public static boolean quadra(ArrayList<Card> hand){
        return DeckOfCards.temQuadra(hand);
    }
    ...
    public static boolean flush(ArrayList<Card> hand){
        return DeckOfCards.temFlush(hand);
    }
    ...
    public static boolean straight(ArrayList<Card> hand){
        return DeckOfCards.temStraight(hand);
    }
    ...
    public static boolean fullHouse(ArrayList<Card> hand){
        return DeckOfCards.temFullHouse(hand);
    }
}
