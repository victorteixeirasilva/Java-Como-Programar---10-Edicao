...
public class Dealer {
    ...
    public void evaluateHand() {
        ...
        switch (poker.mao(hand)) {
            case "Full House", "Straight", "Flush":
                break;
            case "Quadra":
                Card cardParaSubstituir = quadra();
                cartasParaSubstituir.add(cardParaSubstituir);
                replaceUnnecessaryCards(cartasParaSubstituir);
                break;
            case "Trinca":
    ...
    private void replaceUnnecessaryCards(ArrayList<Card> cartasParaSubstituir) {
    ...
    public void showHand() {
        ...
        for (Card card:hand){
            System.out.println();
            switch (card.getFace()) {
                case "11" -> System.out.print("Face: J");
                case "12" -> System.out.print("Face: Q");
                case "13" -> System.out.print("Face: K");
                default -> System.out.print("Face: " + card.getFace());
            }
